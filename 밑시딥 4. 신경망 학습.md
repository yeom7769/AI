...
<img src="4. 신경망 학습.assets/fig 4-2.png" alt="fig 4-2" style="zoom: 50%;" /> 
...
<img src="4. 신경망 학습.assets/e 4.1.png" alt="e 4.1" style="zoom:50%;" /> 
...
<img src="4. 신경망 학습.assets/e 4.2.png" alt="e 4.2" style="zoom:50%;" /> 
...
<img src="4. 신경망 학습.assets/e 4.3.png" alt="e 4.3" style="zoom:50%;" /> 
...
<img src="4. 신경망 학습.assets/e 4.4.png" alt="e 4.4" style="zoom:50%;" /> 👉 x의 작은 변화가 f(x)를 얼마나 변화시키는가?
...
<img src="4. 신경망 학습.assets/fig 4-5.png" alt="fig 4-5" style="zoom: 33%;" /> 
...
<img src="4. 신경망 학습.assets/e 4.6.png" alt="e 4.6" style="zoom: 50%;" /> 

- 위의 함수의 그래프는 아래와 같이 3차원으로 그려진다. 

<img src="4. 신경망 학습.assets/fig 4-8.png" alt="fig 4-8" style="zoom:50%;" /> 
...
- 한 예로 다음과 같이 구현할 수 있음
  ...
  <img src="4. 신경망 학습.assets/fig 4-9.png" alt="fig 4-9" style="zoom: 33%;" /> 
...
<img src="4. 신경망 학습.assets/saddle point.PNG" alt="saddle point" style="zoom:50%;" /> <img src="4. 신경망 학습.assets/plateau.PNG" alt="plateau" style="zoom:50%;" />



2. 경사법(경사 하강법) : 현 위치에서 기울어진 방향으로 이동한 다음 이동한 곳에서 기울기 구해 그 기울어진 방향으로 나아가는 것을 반복함 => 함수의 값을 점차 줄이는 것

   <img src="4. 신경망 학습.assets/e 4.7.png" alt="e 4.7" style="zoom: 50%;" />
...
1. 신경망 기울기
   ...
   <img src="4. 신경망 학습.assets/e 4.8.png" alt="e 4.8" style="zoom:50%;" /> 
...
![fig 4-11](4. 신경망 학습.assets/fig 4-11.png)
...
<img src="4. 신경망 학습.assets/fig 4-12.png" alt="fig 4-12" style="zoom: 33%;" /> 
